...
class ReportDisputePage extends StatelessWidget {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const SizedBox(height: 30),
            Image.asset("assets/images/report.png", height: 120, width: 120),
            const SizedBox(height: 30),
           Padding(
             padding: const EdgeInsets.symmetric(horizontal: 32),
             child: CustomTextField(hintText: "Enter Vendor's username", controller: _usernameController, obscureText: false),
           ),
            const SizedBox(height: 30),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 32),
